...
class LoginRequest extends FormRequest
{
    ...
    {
        return [
            'pengguna_email' => ['required', 'string', 'email'],
    ...
    public function authenticate()
    {
        ...
        if (!Auth::attempt($this->only('pengguna_email', 'pengguna_password'), $this->boolean('remember'))) {
    ...
    public function ensureIsNotRateLimited()
    {
        ...
        throw ValidationException::withMessages([
            'pengguna_email' => trans('auth.throttle', [
                'seconds' => $seconds,
    ...
    {
        return Str::lower($this->input('pengguna_email')) . '|' . $this->ip();
    }
}
